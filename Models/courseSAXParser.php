...
// Called on the text between the start and end of the tags
    public function characterData($parser, $data) {
        ...
        if (!empty($data)) {
            if ($this->elements == 'COURSEID' || $this->elements == 'COURSECODE' || $this->elements == 'COURSENAME' || $this->elements == 'COURSEINFO' || $this->elements == 'CREDITHOUR' || $this->elements == 'STATUS') {
                $this->courses[count($this->courses) - 1][$this->elements] = trim($data);
            }
        }
    }
