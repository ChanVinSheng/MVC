...
class programmeLevelController {
    ...
    function __construct($table, $show) {
        $this->host = 'localhost';
        ...
        $this->sql = "SELECT p.description, l.levelofstudyid, l.type FROM programme p, levelofstudy l "
                . "WHERE p.levelofstudyid = l.levelofstudyid "
                . "AND l.levelofstudyid = '".$show->getName()."'";
