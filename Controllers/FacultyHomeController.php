...
class FacultyHomeController extends Controller {
    ...
    function index() {
        ...
        foreach ($programmedata as $programmes) {
            ...
            $output .= "<td>" . $programmes['LEVELOFSTUDYID'] . "</td>";
            $output .= "<td>" . $programmes['FACULTYID'] . "</td>";
            $output .= "<td>" . $programmes['STATUS'] . "</td>";
            $output .= "</tr>";
        }
        
        $output2 = '<thead>';
        $output2 .= '<tr bgcolor="#ff8000">';
